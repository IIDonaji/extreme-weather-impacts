...
![]("eds223-hw3-README.png") "change"
maps: 
- 1 after storm 
- 2 before storm 
- 3 Houston homes that lost power estimate 
- 4 census tract of Houston homes that lost power plot: household income for census tract that did and did not experience blackouts (median distributions of the ones that did and ones that did not?)

Workflow: 
- find locations that experiance blackout 
- exclude highways
- home locations plus blackouts =homes that experiance blackout 
- census track and blackout
